...
| `deno task test:e2e:regtest` | NWC regtest E2E coverage for multi-participant split-payment completion. |
...
| `deno task test:all:docker` | Regtest E2E gate. Runs `deno task test:e2e:regtest`. |
